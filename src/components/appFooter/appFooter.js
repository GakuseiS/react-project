...
const AppFooter = ({onOpenMap}) => {
    return (
        <div className='footer__container'>
            <div className='footer'>
                <div className='footer__adress'>БАРБЕРШОП «БОРОДИНСКИЙ»<br /> АДРЕС: Г. САНКТ-ПЕТЕРБУРГ, УЛ. Б. КОНЮШЕННАЯ, Д. 19/8<br /> <span onClick={onOpenMap} className='footer__map'>КАК НАС НАЙТИ?</span><br />Телофон: +7 (495) 666-02-66</div>
